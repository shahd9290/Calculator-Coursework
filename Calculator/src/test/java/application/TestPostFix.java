...
class TestPostFix {
  ...
  // Test 3 - Check that extended expressions can be evaluated.
  ...
  // Test 5 - Check if correct value is returned from Subtraction.
  ...
  // Test 12 - Test Invalid Expressions (No operators)
  ...
  // Test 13 - Test Invalid Expressions (Too Many Operators)
  ...
  // Test 14 - Test Invalid Expressions (Only Operators)
  @Test
  ...
  // Test 15 - Test Invalid Expressions (Unknown Symbol)
